                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">อีเว้นท์ทั้งหมด</li>
                            <!--end::Item-->
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <a href="{{ url('admin/events/create') }}" class="btn btn-sm fw-bold btn-primary" >
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">อีเว้นท์ทั้งหมด</span>
                                <span class="text-muted mt-1 fw-semibold fs-7"> จำนวนอีเว้นท์ {{ $count }}</span>
                            </h3>
                        </div>
                                        ...
                                        <tr id="{{$item->id}}">
                                            <td>
                                                <div class="symbol symbol-50px">
                                                    <img src="{{ url('images/mawastudio/img/'.$item->image) }}" alt="">
                                                </div>
                                            </td>
                                            <td>
                                                <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ $item->name }}</a>
                                                <span class="text-muted fw-semibold d-block fs-7"> {{ $item->date_event }}</span>
                                            </td>
                                            ...
                                            <td class="text-end">
                                                <div class="d-flex justify-content-end flex-shrink-0">
                                                    <a href="{{url('admin/events/'.$item->id.'/edit')}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                    ...
                                                    <a href="{{ url('api/del_events/'.$item->id) }}" onclick="return confirm('Are you sure?')" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
...
<script type="text/javascript">
    $(document).ready(function(){
      $("input:checkbox").change(function() {
        ...
        $.ajax({
                type:'POST',
                url:'{{url('api/api_post_status_events')}}',
