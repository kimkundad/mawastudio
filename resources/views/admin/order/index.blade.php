                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">คำสั่งจองทั้งหมด</li>
                            <!--end::Item-->
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">ยอดการจองที่สำเร็จ <b class="text-success"> + {{ number_format($sum,2) }} บาท </b></span>
                                <span class="text-muted mt-1 fw-semibold fs-7"> จำนวนคำสั่งจอง {{ $count }}</span>
                            </h3>
                        </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle gs-0 gy-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="{{$item->id}}">
                                            <td>
                                                <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ $item->username }}</a>
                                                <span class="text-muted fw-semibold d-block fs-7"># {{ $item->order_id }}</span>
                                            </td>
