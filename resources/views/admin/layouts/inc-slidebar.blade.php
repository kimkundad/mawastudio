            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                <div class="menu-item">
                    ...
                    <a class="menu-link" href="{{ url('admin/events') }}">
                        ...
                        <span class="menu-title">จัดการอีเว้นท์</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link" href="{{ url('/admin/order') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
								<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="menu-title">จัดการคำสั่งจอง </span>
                    </a>
                    <!--end:Menu link-->
                </div>
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link" href="{{ url('/admin/donate') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: /var/www/preview.keenthemes.com/kt-products/docs/metronic/html/releases/2023-07-21-074234/core/html/src/media/icons/duotune/general/gen068.svg-->
                                <span class="svg-icon svg-icon-2">
                        ...
                        <span class="menu-title">ยอดบริจาค </span>
                    </a>
                    <!--end:Menu link-->
                </div>
